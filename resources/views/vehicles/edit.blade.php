...
@section('content')
        ...
        <div class="container px-6 mx-auto">
            <h4
                class="mb-2 mt-16 text-lg font-semibold text-gray-600 dark:text-gray-300"> Automobilio {{$vehicle->license_plate}} informacijos atnaujinimas
            </h4>
                    ...
                    <label for="client_id" class="mb-4 block text-sm">
                        ...
                        >
                            @foreach($clients as $client)
                                <option value="{{ $client->id }}" {{ $vehicle->client->id == $client->id ? 'selected' : '' }}>
