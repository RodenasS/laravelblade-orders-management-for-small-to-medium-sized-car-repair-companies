            ...
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tr class="dark:bg-gray-800 text-gray-700 dark:text-gray-400 border-hidden">
                        <td class="px-4 py-3">
                            <input type="text" name="name" class="form-input block w-full dark:bg-gray-800" placeholder="Vardas Pavardė / Pavadinimas" value="{{ request('name') }}">
                        </td>
                        <td class="px-4 py-3">
                            <input type="text" name="clientCode" class="form-input block w-full dark:bg-gray-800" placeholder="Identifikacijos kodas" value="{{ request('clientCode') }}">
                        </td>
                        <td class="px-4 py-3">
                            <input type="email" name="email" class="form-input block w-full dark:bg-gray-800" placeholder="El. paštas" value="{{ request('email') }}">
                        </td>
                        <td class="px-4 py-3">
                            <input type="text" name="phone" class="form-input block w-full dark:bg-gray-800" placeholder="Telefono numeris" value="{{ request('phone') }}">
                        </td>
                        <td class="px-4 py-3">
