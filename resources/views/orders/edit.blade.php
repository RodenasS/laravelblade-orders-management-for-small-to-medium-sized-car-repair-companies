    ...
    <div class="container px-6 mx-auto">
        ...
        <form action="{{ route('orders.update', $order->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <label for="client_id" class="mb-4 block text-sm">
                ...
                <select name="client_id" id="client_id" class="client-select block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray"">
            ...
            <label for="vehicle_id" class="mb-4 block text-sm">
                ...
                <select name="vehicle_id" id="vehicle_id" class="vehicle-select block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray">
            ...
            <label for="estimated_start" class="mb-4 block text-sm">
                ...
                <input type="text" id="estimated_start" name="estimated_start" value="{{ $order->estimated_start }}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
            </label>
            ...
            <label for="estimated_end" class="mb-4 block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Numanoma darbų pradžia:</span>
                <input type="text" id="estimated_start" name="estimated_start" value="{{ $order->estimated_end }}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
            </label>
            @error('estimated_end')
            <p class="text-red-500 text-xs mt-1">{{$message}}</p>
            @enderror
                ...
                <div class="w-full overflow-x-auto">
                    <table class="w-full whitespace-no-wrap">
                        ...
                        @foreach($order->items as $index => $item)
                            <tr>
                                <td class="px-4 py-3">
                                    <input type="text" name="items[{{ $index }}][product_code]" value="{{ $item->product_code }}" class="form-input block w-full" placeholder="Kodas">
                                </td>
                                <td class="px-4 py-3">
                                    <input type="text" name="items[{{ $index }}][product_name]" value="{{ $item->product_name }}" class="form-input block w-full" placeholder="Pavadinimas">
                                </td>
                                <td class="px-4 py-3">
                                    <input type="number" name="items[{{ $index }}][quantity]" value="{{ $item->quantity }}" class="form-input block w-full" placeholder="Kiekis">
                                </td>
                                <td class="px-4 py-3">
                                    <input type="text" name="items[{{ $index }}][unit]" value="{{ $item->unit }}" class="form-input block w-full" placeholder="Vienetai">
                                </td>
                                <td class="px-4 py-3">
                                    <input type="text" name="items[{{ $index }}][unit_price]" value="{{ $item->unit_price }}" class="form-input block w-full" placeholder="Kaina">
                                </td>
                                <td class="px-4 py-3">
                                    <button type="button" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" onclick="removeItem(this)">
